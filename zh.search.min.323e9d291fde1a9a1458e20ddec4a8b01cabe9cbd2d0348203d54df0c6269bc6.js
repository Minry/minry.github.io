...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.47be6f254f96fdaaeadca140ea10802583e2b20426782617a04bcd75c568b240.js',function(){input.required=false;search();});}
